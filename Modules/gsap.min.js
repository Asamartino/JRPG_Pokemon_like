...
!(function (t, e) {
  ...
  function ta(t, e) {
    if (t && (!e || e._end > t._dur || e._start < 0))
      for (let r = t; r; ) (r._dirty = 1), (r = r.parent);
    return t;
  }
  function wa(t) {
  ...
  function Ja(t, e, r, i) {
    ...
    return (
      ...
      s > 0 && !i ? Aa(t, (t._tTime = t._tDur * s)) : t.parent && za(t),
      r || ta(t.parent, t),
      t
    );
  }
  ...
  function Ya(t) {
    if (p(t)) return t;
    const c = s(t) ? t : { each: t };
    let _ = Rt(c.ease);
    const m = c.from || 0;
    const g = parseFloat(c.base) || 0;
    const v = {};
    const e = m > 0 && m < 1;
    const y = isNaN(m) || e;
    const b = c.axis;
    ...
    return (
      ...
      function (t, e, r) {
        ...
        let p = v[d];
        if (!p) {
          if (!(f = c.grid === 'auto' ? 0 : (c.grid || [1, j])[1])) {
            for (
              h = -j;
          ...
          for (
            ...
            (a = (u % f) - i),
              (s = n - ((u / f) | 0)),
              (p[u] = o = b ? Math.abs(b === 'y' ? s : a) : G(a * a + s * s)),
              h < o && (h = o),
              o < l && (l = o);
          m === 'random' && Xa(p),
            (p.max = h - l),
  ...
  function Za(r) {
    const i = 10 ** (`${r}`.split('.')[1] || '').length;
    return function (t) {
      const e = Math.round(parseFloat(t) / r) * r * i;
  ...
  function rb(t, e, r) {
    ...
    let f;
    let d;
    let p = t ? (q(t) ? [t >> 16, (t >> 8) & kt, t & kt] : 0) : Ct.black;
    if (!p) {
      if ((t.substr(-1) === ',' && (t = t.substr(0, t.length - 1)), Ct[t]))
        ...
        if (
          (t.length < 6 &&
            (t = `#${(i = t.charAt(1))}${i}${(n = t.charAt(2))}${n}${(a =
              t.charAt(3))}${a}${
  ...
  function Lb(r, t, e) {
    function Sl(t) {
      return t === 1 ? 1 : i * 2 ** (-10 * t) * K((t - a) * n) + 1;
    }
    var i = t >= 1 ? t : 1;
    var n = (e || (r ? 0.3 : 0.45)) / (t < 1 ? t : 1);
    var a = (n / U) * (Math.asin(1 / i) || 0);
    const s =
      r === 'out'
        ? Sl
        : r === 'in'
  ...
  const L = { duration: 0.5, overwrite: !1, delay: 0 };
  var j = 1e8;
  var X = 1 / j;
  var U = 2 * Math.PI;
  const V = U / 4;
  ...
  const yt = { _start: 0, endTime: Q, totalDuration: Q };
  var bt = function _parsePosition(t, e, r) {
    let i;
    let n;
    let a;
    const s = t.labels;
    const u = t._recent || yt;
    const h = t.duration() >= j ? u.endTime(!1) : t._dur;
      ...
      ? ((n = e.charAt(0)),
        ...
        n === '<' || n === '>'
          ...
          : ((n = parseFloat(e.charAt(i - 1) + e.substr(i + 1))),
            ...
            i > 1 ? _parsePosition(t, e.substr(0, i - 1), r) + n : h + n))
      : e == null
      ? h
      : +e;
  };
  var Tt = function _clamp(t, e, r) {
    return r < t ? t : e < r ? e : r;
  };
  const wt = [].slice;
  var xt = function toArray(t, e, r) {
    return !o(t) || r || (!n && Dt())
      ? W(t)
        ? (function _flatten(t, e, r) {
            return (
              void 0 === r && (r = []),
              t.forEach((t) =>
                (o(t) && !e) || Ta(t, 1) ? r.push.apply(r, xt(t)) : r.push(t)
              ) || r
            );
          })(t, r)
        : Ta(t)
  ...
  const Ot = function mapRange(e, t, r, i, n) {
    const a = t - e;
    const s = i - r;
    return Oa(n, (t) => r + (((t - e) / a) * s || 0));
  };
  var Mt = function _callback(t, e, r) {
    let i;
    let n;
    const a = t.vars;
    const s = a[e];
  ...
  var Dt = function _wake() {
    return !c && St.wake();
  };
  var zt = {};
  var Ft = /^[\d.\-M][\d.\-,\s]/;
  var Et = /["']/g;
  var Bt = function _invertEase(e) {
    return function (t) {
      return 1 - e(1 - t);
    };
  };
  ...
  function pm(t) {
    return t < B
      ...
      : E * (t - 2.625 / 2.75) ** 2 + 0.984375;
  }
  ba('Linear,Quad,Cubic,Quart,Quint,Strong', (t, e) => {
    const r = e < 5 ? e + 1 : e;
    Jb(
      `${t},Power${r - 1}`,
      e ? (t) => t ** r : (t) => t,
    ...
    (E = 7.5625),
    (B = 1 / 2.75),
    Jb('Bounce', (t) => 1 - pm(1 - t), pm),
    Jb('Expo', (t) => (t ? 2 ** (10 * (t - 1)) : 0)),
    Jb('Circ', (t) => -(G(1 - t * t) - 1)),
    Jb('Sine', (t) => (t === 1 ? 1 : 1 - Z(t * V))),
  ...
  const qt =
    ...
    (It.startTime = function startTime(t) {
      if (arguments.length) {
        ...
        return (
          !e || (!e._sort && this.parent) || Ca(e, this, t - this._delay), this
        );
      }
      return this._start;
    }),
    ...
    return (
      ...
      (e.add = function add(t, e) {
        ...
        if ((q(e) || (e = bt(this, e, t)), !(t instanceof qt))) {
          if (W(t)) return t.forEach((t) => r.add(t, e)), this;
      ...
      (e.getById = function getById(t) {
        for (let e = this.getChildren(1, 1, 1), r = e.length; r--; )
      ...
      (e.addPause = function addPause(t, e, r) {
        const i = Jt.delayedCall(0, e || Q, r);
        return (
      ...
      (e.removePause = function removePause(t) {
        let e = this._first;
        for (t = bt(this, t); e; )
          e._start === t && e.data === 'isPause' && sa(e), (e = e._next);
      }),
      (e.killTweensOf = function killTweensOf(t, e, r) {
        for (let i = this.getTweensOf(t, r), n = i.length; n--; )
          Qt !== i[n] && i[n].kill(t, e);
        return this;
      }),
  ...
  let Qt;
  const Yt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
    p(i) && (i = i(n || 0, t, a));
    let l;
    const f = t[e];
    const d =
      ...
      return isNaN(d * i) || i === ''
        ? (f || e in t || N(e, i),
          function _addComplexStringPropTween(t, e, r, i, n, a, s) {
            ...
            let p;
            let c;
            const _ = new ae(this._pt, t, e, 0, 1, te, null, n);
            let m = 0;
            let g = 0;
            for (
              _.b = r,
  ...
  var jt = function _initTween(e, r) {
    ...
    let v = g.ease;
    const y = g.startAt;
    let b = g.immediateRender;
    let T = g.lazy;
    const w = g.onUpdate;
    const x = g.onUpdateParams;
    const O = g.callbackScope;
    const M = g.runBackwards;
    let k = g.yoyoEase;
    const C = g.keyframes;
    const P = g.autoRevert;
    const A = e._dur;
    const S = e._startAt;
    const D = e._targets;
    const z = e.parent;
    const F = z && z.data === 'nested' ? z.parent._targets : D;
    const E = e._overwrite === 'auto' && !R;
    const B = e.timeline;
    if (
      (!B || (C && v) || (v = 'none'),
      (e._ease = Rt(v, L.ease)),
  ...
  var Xt = function _parseFuncOrString(t, e, r, i, n) {
    return p(t)
      ? t.call(e, r, i, n)
  ...
  const Ut = `${_t}repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase`;
  const Vt = {};
  ba(
    `${Ut},id,stagger,delay,duration,paused,scrollTrigger`,
    (t) => (Vt[t] = 1)
  );
  var Jt = (function (F) {
    function Tween(e, r, i, n) {
      ...
      let p;
      let c;
      const _ = (a = F.call(this, n ? r : oa(r)) || this).vars;
      let m = _.duration;
      let g = _.delay;
      const y = _.immediateRender;
      const b = _.stagger;
      const T = _.overwrite;
      const w = _.keyframes;
      const x = _.defaults;
      const M = _.scrollTrigger;
      const k = _.yoyoEase;
      const C = r.parent || I;
      const P = (W(e) || H(e) ? q(e[0]) : 'length' in r) ? [e] : xt(e);
      if (
        ((a._targets = P.length
          ? $(P)
          : O(
        ...
        if (
          ...
          let D;
          let z = 0;
          if (W(w)) w.forEach((t) => o.to(P, t, '>'));
          else {
            for (f in ((h = {}), w))
              f === 'ease' || f === 'easeEach' || Xb(f, w[f], h, w.easeEach);
            for (f in h)
              for (
                A = h[f].sort((t, e) => t.t - e.t), u = z = 0;
                u < A.length;
                u++
              )
                ((D = {
    ...
    return (
      ...
      (e.kill = function kill(t, e) {
        ...
        if (
          ...
          return e === 'all' && (this._pt = 0), lb(this);
        for (
          i = this._op = this._op || [],
            e !== 'all' &&
              (o(e) && ((u = {}), ba(e, (t) => (u[t] = 1)), (e = u)),
              (e = (function _addAliasesToVars(t, e) {
                let r;
                let i;
                let n;
                let a;
                const s = t[0] ? _(t[0]).harness : 0;
                const o = s && s.aliases;
                if (!o) return e;
                for (i in ((r = mt({}, e)), o))
                  if ((i in r))
  ...
  var Kt = function _getSetter(t, e) {
    return p(t[e]) ? $t : r(t[e]) && t.setAttribute ? dc : Gt;
  };
  var Ht = function _renderPlain(t, e) {
    return e.set(e.t, e.p, Math.round(1e6 * (e.s + e.c * t)) / 1e6, e);
  };
  var Wt = function _renderBoolean(t, e) {
    return e.set(e.t, e.p, !!(e.s + e.c * t), e);
  };
  var te = function _renderComplexString(t, e) {
    let r = e._pt;
    let i = '';
    if (!t && e.b) i = e.b;
  ...
  const ee = function _renderPropTweens(t, e) {
    for (let r = e._pt; r; ) r.r(t, r.d), (r = r._next);
  };
  const re = function _addPluginModifier(t, e, r, i) {
    for (var n, a = this._pt; a; )
      (n = a._next), a.p === i && a.modifier(t, e, r), (a = n);
  };
  const ie = function _killPropTweensOf(t) {
  ...
  var ne = function _sortPropTweensByPriority(t) {
  ...
  const se = {
    ...
    quickSetter: function quickSetter(r, e, i) {
      if ((r = xt(r)).length > 1) {
        const n = r.map((t) => oe.quickSetter(t, e, i));
        const a = n.length;
        return function (t) {
          for (let e = a; e--; ) n[e](t);
        };
    ...
    registerEffect: function registerEffect(t) {
      ...
      (e || '')
        .split(',')
        .forEach(
          (t) => t && !ft[t] && !ot[t] && O(`${i} effect requires ${t} plugin.`)
        ),
        (dt[i] = function (t, e, r) {
  ...
  ba('to,from,fromTo,delayedCall,set,killTweensOf', (t) => (se[t] = Jt[t])),
  ...
  function zd(t, e, r, i, n, a) {
    const s = new ae(t._pt, e, r, 0, 1, a ? fd : ed);
  ...
  function Dd(t, e, r, i) {
    if (!r || r === 'none') {
      ...
      a && a !== r
        ? ((e = n), (r = a))
        : e === 'borderColor' && (r = qd(t, 'borderTopColor'));
    }
    let s;
    let o;
    let u;
    ...
    let m;
    let g;
    const v = new ae(this._pt, t.style, e, 0, 1, te);
    let y = 0;
    let b = 0;
    if (
      ((v.b = r),
      ...
      for (; (o = rt.exec(i)); )
        (d = o[0]),
          ...
          l
            ? (l = (l + 1) % 5)
            : (c.substr(-5) !== 'rgba(' && c.substr(-5) !== 'hsla(') || (l = 1),
          d !== (f = u[b++] || '') &&
            ((h = parseFloat(f) || 0),
            (m = f.substr(`${h}`.length)),
    ...
    } else v.r = e === 'display' && i === 'none' ? fd : ed;
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if (o === 'all' || !0 === o) (s.cssText = ''), (i = 1);
        ...
        for (n = (o = o.split(',')).length; --n > -1; )
          (r = o[n]),
            Fe[r] && ((i = 1), (r = r === 'transformOrigin' ? Ye : Qe)),
            yd(a, r);
      i &&
        (yd(a, Qe),
        u &&
  ...
  function Nd(t, e, r, i, n, a) {
    ...
    let b = l[5];
    const T = e.split(' ');
    let w = parseFloat(T[0]) || 0;
    let x = parseFloat(T[1]) || 0;
    r
      ? l !== Ge &&
        (o = _ * v - m * g) &&
  ...
  function Xd(t, e, r, i, n, a) {
    ...
    const h = 360;
    const l = o(n);
    const f = parseFloat(n) * (l && ~n.indexOf('rad') ? Ee : 1);
    let d = a ? f * a : f - i;
    const p = `${i + d}deg`;
    return (
      l &&
  ...
  var Xe = function _checkPropPrefix(t, e, r) {
    const i = (e || de).style;
    let n = 5;
  ...
  var Je = {
    clearProps: function clearProps(t, e, r, i, n) {
      if (n.data !== 'isFromStart') {
        const a = (t._pt = new ae(t._pt, e, r, 0, 0, Gd));
  ...
  var Ke = function _firstTwoOnly(t) {
  ...
  const tr = '0px';
  const er = ') ';
  var rr = function _renderCSSTransforms(t, e) {
    const r = e || this;
    const i = r.xPercent;
    const n = r.yPercent;
    let a = r.x;
    ...
    const v = r.zOrigin;
    let y = '';
    const b = (m === 'auto' && t && t !== 1) || !0 === m;
    if (v && (l !== We || h !== We)) {
      let T;
      let w = parseFloat(h) * Be;
      const x = Math.sin(w);
      const O = Math.cos(w);
      (w = parseFloat(l) * Be),
        (T = Math.cos(w)),
    ...
    _ !== tr && (y += `perspective(${_}${er}`),
      ...
      (p === 1 && c === 1) || (y += `scale(${p}, ${c}${er}`),
      (g.style[Qe] = y || 'translate(0, 0)');
  };
  var ir = function _renderSVGTransforms(t, e) {
    let r;
    let i;
    let n;
    let a;
  ...
  ba('padding,margin,Width,Radius', (e, r) => {
    const t = 'Right';
    const i = 'Bottom';
    const n = 'Left';
    const o = (
      r < 3 ? ['Top', t, i, n] : [`Top${n}`, `Top${t}`, i + t, i + n]
    ).map((t) => (r < 2 ? e + t : `border${t}${e}`));
    Je[r > 1 ? `border${e}` : e] = function (e, t, r, i, n) {
      let a;
      let s;
  ...
  const or = {
    ...
    init: function init(t, e, r, i, n) {
      ...
      const T = this._props;
      const w = t.style;
      const x = r.vars.startAt;
      for (d in (fe || td(), e))
        if (d !== 'autoRound' && ((s = e[d]), !ft[d] || !Tb(d, e, r, i, t, n)))
          if (
            ((l = typeof s),
            (f = Je[d]),
            l === 'function' && (l = typeof (s = s.call(r, i, t, n))),
            l === 'string' && ~s.indexOf('random(') && (s = gb(s)),
            f)
          )
            f(this, t, d, s, r) && (b = 1);
            ...
            if (
              (x && d in x
                ? ((a =
                    typeof x[d] === 'function' ? x[d].call(r, i, t, n) : x[d]),
              ...
              d in Ne &&
                (d === 'autoAlpha' &&
                  (h === 1 && Cd(t, 'visibility') === 'hidden' && u && (h = 0),
                  zd(
                    this,
                    w,
                    'visibility',
              ...
              if (
                ...
                if (d === 'transformOrigin') {
                  (s = Fd(s)),
                    v.svg
                      ? Nd(t, s, 0, y, 0, this)
                      : ((c = parseFloat(s.split(' ')[2]) || 0) !== v.zOrigin &&
                          zd(this, v, 'zOrigin', v.zOrigin, c),
  ...
  (oe.utils.checkPrefix = Xe),
    (sr = ba(
      `${(nr = 'x,y,z,scale,scaleX,scaleY,xPercent,yPercent')},${(ar =
        'rotation,rotationX,rotationY,skewX,skewY')},transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective`,
      (t) => {
        Fe[t] = 1;
      }
    )),
  ...
  const ur = oe.registerPlugin(or) || oe;
  const hr = ur.core.Tween;
  (e.Back = Ce),
    (e.Bounce = Ae),
    (e.CSSPlugin = or),
    (e.Circ = ze),
